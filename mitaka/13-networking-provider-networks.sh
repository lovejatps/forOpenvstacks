...
sed -i "/^core_plugin = ml2/,+0aservice_plugins = " /etc/neutron/neutron.conf
...
sed -i "/\[ml2\]/,+0atype_drivers = flat,vlan" /etc/neutron/plugins/ml2/ml2_conf.ini
sed -i "/\[ml2\]/,+0atenant_network_types = " /etc/neutron/plugins/ml2/ml2_conf.ini
sed -i "/\[ml2\]/,+0amechanism_drivers = linuxbridge" /etc/neutron/plugins/ml2/ml2_conf.ini
...
sed -i "/^\[DEFAULT\]/,+0aexternal_network_bridge =" /etc/neutron/l3_agent.ini
